...
//        return super.onCreateView(inflater, container, savedInstanceState)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        idSpinner = view.findViewById(R.id.idMenu_spin)
        namaMenuUpdateEt = view.findViewById(R.id.nama_update_et)
        deskripsiMenuUpdateEt = view.findViewById(R.id.deskripsi_update_et)
        hargaMenuUpdateEt = view.findViewById(R.id.harga_update_et)
        updateBtn = view.findViewById(R.id.update_btn)
        showHasilUpdate = view.findViewById(R.id.showHasilUpdate_lv)
